  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">Season Analytics</p>
      </div>
        ...
        <table className="min-w-full">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              ...
              <ColHeader k="designatedStarts" label="D-Starts" title="Designated starts (Pass 1 starter for their slot)" />
          ...
          <tbody>
            {sortedPlayers?.map((p, i) => (
              ...
              >
                ...
                <td className="px-3 py-2.5 text-sm text-center text-blue-700 font-medium">
                  {p.appearances.starter > 0 ? p.appearances.starter : <Dash />}
                </td>
                <td className="px-3 py-2.5 text-sm text-center text-green-700 font-medium">
                  {p.appearances.sub > 0 ? p.appearances.sub : <Dash />}
                </td>
                <td className="px-3 py-2.5 text-sm text-center text-purple-700 font-medium">
      ...
      <div className="mt-4 flex flex-wrap gap-x-6 gap-y-1 text-xs text-gray-500">
        <span>
          <span className="text-blue-600 font-medium">STR</span> — First player activated at their lineup slot
        </span>
        <span>
          <span className="text-green-600 font-medium">SUB</span> — Additional player added to the same slot
        </span>
        <span>
          <span className="text-purple-600 font-medium">XTR</span> — Activated in XTRA tie-breaker
        </span>
        <span>
          <span className="font-medium">D-Starts</span> — Times as designated starter (simulated Pass 1)
        </span>
      </div>
    </div>
  );
