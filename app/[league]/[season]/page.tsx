  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {userTeamId && (
          <Link href={`${base}/teams/${userTeamId}?tab=roster`} className="bg-white p-5 rounded-lg border border-gray-200 hover:border-purple-400 hover:shadow transition group">
            <div className="text-2xl mb-2">🏢</div>
